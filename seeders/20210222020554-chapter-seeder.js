...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    await queryInterface.bulkInsert('db_quiz_chapters', chapters, {});

  },

  down: async (queryInterface, Sequelize) => {
    await queryInterface.bulkDelete('db_quiz_chapters', null, {});
    await queryInterface.sequelize.query('ALTER TABLE db_quiz_chapters AUTO_INCREMENT = 1');
  }
};
